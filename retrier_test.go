...
func TestRetry_WithExponentialWithEqualJitterBackoff(t *testing.T) {
	t.Parallel()
...
func TestRetry_WithExponentialWithFullJitterBakoff(t *testing.T) {
	t.Parallel()
...
func TestRetry_WithExponentialWithDecorrelatedJitterBackoff(t *testing.T) {
	t.Parallel()
